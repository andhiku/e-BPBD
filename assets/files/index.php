		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default turun">
				<div class="panel-heading">
					<img src="../images/brand.png" class="pull-right hidden-xs">
			  ...
			  <div class="panel-footer">
			  	...
			  	<img src="../images/icon.png" width="250">
                                <a href="<?php echo base_url() ?>" class="btn btn-default pull-right hidden-xs"><i class="fa fa-sign-out"></i> Back to application</a>
			  </div>
			</div>
		</div>
	</div>
